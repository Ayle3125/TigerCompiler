...
public class CopyProp implements cfg.Visitor
{
    ...
    public boolean isVar(Operand.T t) {
        if (t == null)
            return false;
        return t.getClass().getName().equals("cfg.Cfg.Operand.Var");
    }
    
    public Operand.T propVar(Operand.T operand, Stm.T stm) {
        ...
        for (Stm.T t : set) {
            if (t.dst.equals(operand.toString())) {
                ...
                if (t.getClass().getName().toString().equals("cfg.Cfg.Stm.Move")) {
                    ...
                    if (move.src.getClass().getName().toString().equals("cfg.Cfg.Operand.Var")) {
                        return move.src;
                    }
                }
            }
    ...
    {
        Operand.T temp = propVar(s.src, s);
        ...
        if (!s.src.toString().equals(temp.toString()) && !s.dst.startsWith("(this->") && !s.dst.startsWith("this->")
            ...
            this.stmm = new Stm.Move(s.dst, s.ty, temp);

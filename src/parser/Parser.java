...
public class Parser
{
    ...
    private Exp.T parseAtomExp()
    {
        ...
        case TOKEN_NUM:
            ...
            return new Num(current.lineNum, num);
        case TOKEN_TRUE:
            advance();
            return new True(current.lineNum);
        case TOKEN_FALSE:
            advance();
            return new False(current.lineNum);      
        case TOKEN_THIS:
            advance();
            return new This(current.lineNum);
        case TOKEN_ID:
            String id=current.lexeme;
            
            advance();
            return new Id(current.lineNum,id);
        ...
        case TOKEN_NEW: {
            ...
            case TOKEN_INT: 
                ...
                return new NewIntArray(current.lineNum,exp);
            ...
            case TOKEN_ID:
                ...
                return new NewObject(current.lineNum,idd);
            default:
                error();
                return null;
            }
        ...
        while (current.kind == Kind.TOKEN_DOT || current.kind == Kind.TOKEN_LBRACK) {
            if (current.kind == Kind.TOKEN_DOT) {
                ...
                if (current.kind == Kind.TOKEN_LENGTH) {
                    ...
                    return new Length(current.lineNum,exp);
                }
                ...
                return new Call(current.lineNum, exp, id, args);
                ...
                return new ArraySelect(current.lineNum, exp, expp);
            }
        }
        return exp;
    ...
    private Exp.T parseTimesExp()
    {
        ...
        while (current.kind == Kind.TOKEN_NOT) {
            advance();
            exp = parseNotExp();
            return new Not(current.lineNum, exp);
    ...
    private Exp.T parseAddSubExp()
    {
        ...
        {
            return new Times(current.lineNum, left, right);
        }
    ...
    private Exp.T parseLtExp()
    {
        ...
        while (current.kind == Kind.TOKEN_ADD || current.kind == Kind.TOKEN_SUB) {
            if(current.kind==Kind.TOKEN_ADD)
            {
                ...
                return new Add(current.lineNum, left, right);
            ...
            else if(current.kind==Kind.TOKEN_SUB)
            {
                ...
                return new Sub(current.lineNum, left, right);
            }
        }
    ...
    private Exp.T parseAndExp()
    {
        ...
        if(right==null)
        {
            ...
            return new Lt(current.lineNum, left, right);
        }
    ...
    private Exp.T parseExp()
    {
        ...
        if(right==null)
        {
            ...
            return new And(current.lineNum, left, right);
        }
    ...
    private Type.T parseType()
    {
        ...
        if(current.kind==Kind.TOKEN_INT)
        {
            ...
            if(current.kind==Kind.TOKEN_LBRACK)
            {
                eatToken(Kind.TOKEN_LBRACK);
                eatToken(Kind.TOKEN_RBRACK);
                return new Type.IntArray(current.lineNum);
            }
            return new Type.Int(current.lineNum);
        }
        else if(current.kind== Kind.TOKEN_BOOLEAN) 
        {
            eatToken(Kind.TOKEN_BOOLEAN);
            return new Type.Boolean(current.lineNum);
        ...
        else if(current.kind==Kind.TOKEN_ID)
        {
            String id = current.lexeme;
            eatToken(Kind.TOKEN_ID);
            return new Type.ClassType(current.lineNum,id);	
        }
        return null;
    }
